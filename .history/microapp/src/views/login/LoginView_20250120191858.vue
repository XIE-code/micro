...
export default({
 ...
 <style scoped>  
        ...
        .body .box .box_right .box_right_center .box_right_center_img img{
        ...
        @media (max-width: 90.125rem) and (min-width: 62.5rem) {
            .body .box .box_left_center_box .Login_head {
                    margin-left: .625rem;
                }
             .body .box .box_right .box_right_center img{
        ...
        /* 屏幕宽度大于75rem之间的样式 */
        @media (max-width:81.25rem) and (min-width: 75rem) {
